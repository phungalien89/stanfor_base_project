    ...
    if(isset($_REQUEST['btnAddBike'])){
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            if($dataOK){
                ...
                unset($_SESSION['bike_action']);
                $_SESSION['message'][] = ['title'=>'Thêm mới sản phẩm', 'status'=>'success', 'content'=>'Đã thêm <b>'. $bike->bikeName .'</b> thành công!'];
                echo "<script>location.assign('http://localhost:63342/Website/admin/AdminPage.php')</script>";
            }
        ...
        <div class="row pt-4">
            <div class="col-sm-10 col-md-8 col-lg-6 mx-auto">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form_addBike" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea class="form-control ckEditor" name="txtBikeGift" id="txtBikeGift" cols="30"
                                             rows="10" style="resize: vertical"><?= $bikeGift ?></textarea>
                                    <div class="autosave-header">
                                        <div class="autosave-server">
                                            <span class="far fa-clock text-primary"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row mx-auto w-50 pt-3">
                                    <img id="bike_file_image" class="rounded-circle w-100" src="" alt="">
                                </div>
                                <?php
                            ...
                            <div class="form-group pt-3">
                                <div class="d-flex">
                                    <button id="btnAddBike" name="btnAddBike" class="btn btn-outline-primary">
                                        <span class="fa fa-check"></span>
                                        <span class="text-uppercase">Thêm mới</span>
                                    </button>
                                    <button type="submit" id="btnBikeReturn" name="btnBikeReturn" class="btn btn-outline-danger ml-auto">
...
<script>
    ...
    let add_bike_short_desc_Editor = document.querySelector('#txtBikeShortDesc');
    ClassicEditor.create(add_bike_short_desc_Editor, {
        ckfinder:{
    ...
    .then(add_bike_short_desc_Editor => {
        originEditor_bike_short_desc = add_bike_short_desc_Editor;
    ...
    let add_bike_gift_Editor = document.querySelector('#txtBikeGift');
    ClassicEditor.create(add_bike_gift_Editor, {
        ckfinder:{
            uploadUrl: 'http://localhost:63342/Website/vendor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files&responseType=json'
        },
        fontFamily: {
    ...
    .then(add_bike_gift_Editor => {
        originEditor_bike_gift = add_bike_gift_Editor;
    ...
    let add_bike_highlight_Editor = document.querySelector('#txtBikeHighlight');
    ClassicEditor.create(add_bike_highlight_Editor, {
        ckfinder:{
            uploadUrl: 'http://localhost:63342/Website/vendor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files&responseType=json'
        },
        fontFamily: {
    ...
    .then(add_bike_highlight_Editor => {
        originEditor_bike_highlight = add_bike_highlight_Editor;
    ...
    let add_bike_specs_Editor = document.querySelector('#txtBikeSpecs');
    ClassicEditor.create(add_bike_specs_Editor, {
        ckfinder:{
            uploadUrl: 'http://localhost:63342/Website/vendor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files&responseType=json'
        },
        fontFamily: {
    ...
    .then(add_bike_specs_Editor => {
        originEditor_bike_specs = add_bike_specs_Editor;
    ...
    let add_bike_gallery_Editor = document.querySelector('#txtBikeGallery');
    ClassicEditor.create(add_bike_gallery_Editor, {
        ckfinder:{
            uploadUrl: 'http://localhost:63342/Website/vendor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files&responseType=json'
        },
        fontFamily: {
    ...
    .then(add_bike_gallery_Editor => {
        originEditor_bike_gallery = add_bike_gallery_Editor;
        startTimer_gallery(savingInterval);
    })
    .catch(error => {
        console.log("Error at initializing Editor: " + error);
    });
    ...
    function startTimer_shortDesc(interval){
        intervalId_bike_short_desc = setInterval(()=>{
            ...
            if(!saved_shortDesc){
                httpRequest_shortDesc.open("POST", "http://localhost:63342/Website/admin/autosave.php?add_bike_short_desc=" + e.getData().replace(/&nbsp;/g, "").replace(/%/g, "o_o"), true);
    ...
    function startTimer_gift(interval){
        intervalId_bike_gift = setInterval(()=>{
            ...
            if(!saved_gift){
                httpRequest_gift.open("POST", "http://localhost:63342/Website/admin/autosave.php?add_bike_gift=" + e.getData().replace(/&nbsp;/g, "").replace(/%/g, "o_o"), true);
    ...
    function startTimer_highlight(interval){
        intervalId_bike_highlight = setInterval(()=>{
            ...
            if(!saved_highlight){
                httpRequest_highlight.open("POST", "http://localhost:63342/Website/admin/autosave.php?add_bike_highlight=" + e.getData().replace(/&nbsp;/g, "").replace(/%/g, "o_o"), true);
    ...
    function startTimer_specs(interval){
        intervalId_bike_specs = setInterval(()=>{
            ...
            if(!saved_specs){
                httpRequest_specs.open("POST", "http://localhost:63342/Website/admin/autosave.php?add_bike_specs=" + e.getData().replace(/&nbsp;/g, "").replace(/%/g, "o_o"), true);
    ...
    function startTimer_gallery(interval){
        intervalId_bike_gallery = setInterval(()=>{
            ...
            if(!saved_gallery){
                httpRequest_gallery.open("POST", "http://localhost:63342/Website/admin/autosave.php?add_bike_gallery=" + e.getData().replace(/&nbsp;/g, "").replace(/%/g, "o_o"), true);
    ...
    $(document).ready(()=>{
        ...
        $('#btnReload_addBikeShortDesc').on("click", ()=>{
            ...
            if(r){
                ...
                httpRequest.open("GET", "http://localhost:63342/Website/admin/autosave.php?get_add_bike_short_desc=true", true);
                httpRequest.send();
        ...
        $('#btnReload_addBikeGift').on("click", ()=>{
            if(confirm("All data in this textarea will be replaced by data on server?")){
                ...
                httpRequest.open("GET", "http://localhost:63342/Website/admin/autosave.php?get_add_bike_gift=true", true);
                httpRequest.send();
        ...
        $('#btnReload_addBikeHighlight').on("click", ()=>{
            if(confirm("All data in this textarea will be replaced by data on server?")){
                ...
                httpRequest.open("GET", "http://localhost:63342/Website/admin/autosave.php?get_add_bike_highlight=true", true);
                httpRequest.send();
        ...
        $('#btnReload_addBikeSpecs').on("click", ()=>{
            if(confirm("All data in this textarea will be replaced by data on server?")){
                ...
                httpRequest.open("GET", "http://localhost:63342/Website/admin/autosave.php?get_add_bike_specs=true", true);
                httpRequest.send();
        ...
        $('#btnReload_addBikeGallery').on("click", ()=>{
            if(confirm("All data in this textarea will be replaced by data on server?")){
                ...
                httpRequest.open("GET", "http://localhost:63342/Website/admin/autosave.php?get_add_bike_gallery=true", true);
                httpRequest.send();
